//
//  YZMovementsCollectionLayoutInfo.m
//  Texture
//
...
@implementation YZMovementsCollectionLayoutInfo
...
- (BOOL)isEqualToInfo:(YZMovementsCollectionLayoutInfo *)info
{
  if (info == nil) {
    return NO;
  }
...
- (BOOL)isEqual:(id)other
{
  ...
  if (! [other isKindOfClass:[YZMovementsCollectionLayoutInfo class]]) {
    return NO;
  }
