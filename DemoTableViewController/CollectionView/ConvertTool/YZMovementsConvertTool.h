...
+ (void)convertJsonToModelsWithFile:(NSString *)fileName numberIndex:(NSInteger)numberIndex complete:(ConvertDataCompleteHandle)complete;
// 七乐彩
...
+ (void)convertFucai3DJsonToModelsWithFile:(NSString *)fileName numberIndex:(NSInteger)numberIndex complete:(ConvertDataCompleteHandle)complete;
// 福彩3D 大小形态分布
