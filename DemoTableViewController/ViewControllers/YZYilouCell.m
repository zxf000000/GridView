...
NSString *const YZYilouCellId = @"YZYilouCellId";

@interface YZYilouCell ()
...
@implementation YZYilouCell

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        _movementsDataSource = [[YZFucai3DYilouMovementsDataSource alloc] init];
        _movementsDataSource.itemSize = CGSizeMake(frame.size.width / 6.f, 30.f);
        [self setupUI];
    }
    return self;
}
...
- (void)setDatas:(id)datas {
    ...
    _movementsDataSource.columnCount = 6;
